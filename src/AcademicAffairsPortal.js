        ...
        <Content style={{ 
          ...
          >
            <AnimatePresence mode="wait">
              ...
              >
                {selectedKey === 'dashboard' && <DashboardContent semesters={semesters} students={students} lecturers={lecturers} enrollments={enrollments} />}
...
// Dashboard Component
const DashboardContent = ({ semesters, students, lecturers, enrollments }) => (
  <div>
    <Row gutter={[24, 24]}>
