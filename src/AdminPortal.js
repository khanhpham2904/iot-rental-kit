...
import { mockKits, mockGroups, mockUsers, mockRentalRequests, mockRefundRequests, mockRolePermissions, mockSystemStats, mockMaintenanceSchedule, mockTransactions } from './mocks';
          ...
          >
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {selectedKey === 'rentals' && <RentalApprovals rentalRequests={rentalRequests} setRentalRequests={setRentalRequests} generateQRCode={generateQRCode} />}
                {selectedKey === 'refunds' && <RefundApprovals refundRequests={refundRequests} setRefundRequests={setRefundRequests} openRefundKitInspection={openRefundKitInspection} />}
...
const RentalApprovals = ({ rentalRequests, setRentalRequests, generateQRCode }) => {
...
const RefundApprovals = ({ refundRequests, setRefundRequests, openRefundKitInspection }) => {
  const columns = [
    {
      title: 'Request ID',
      dataIndex: 'id',
